...
import HeroImg from "../Images/HeroPet.jpg";
const HeroSection = () => {
  return (
    <div>
        ...
        <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
          <div>
            <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight">
              ...
              <span class="text-[#14b8a6]">Tail Wags</span> and{" "}
              <span class="text-[#14b8a6]"> Purrs</span>
            </h1>
            <p class="mt-3 text-lg text-gray-800">
              Your Pet Paradise Awaits For Your Attention
            </p>

            <div class="mt-7 grid gap-3 w-full sm:inline-flex">
              <a
                class="py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-[#14b8a6] text-white hover:bg-[#14b8a5cb] disabled:opacity-50 disabled:pointer-events-none"
                href="/"
              >
                Get started
                <svg
          ...
          <div class="relative ms-4">
            <img class="w-full rounded-md" src={HeroImg} alt=" Description" />
